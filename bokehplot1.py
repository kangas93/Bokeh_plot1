...
def modify_doc(doc):
    ...
    def make_dataset(selected_options):
        ...
        by_factor_range_injured = by_factor_injured.head(selected_options[3])
    ...
    def make_plot(src):
        ...
        p_lin = figure(y_range=FactorRange(factors=list(src.data['no_factors'])),plot_width = 700, plot_height = 450, title = 'Bar plot of no of victims injured or killed',
